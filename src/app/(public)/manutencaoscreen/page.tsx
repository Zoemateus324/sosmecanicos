  ...
  return (
    <div className="flex flex-col gap-[2%] flex-wrap content-start sim:mt-4">
      <div className="flex-1 container p-4 flex justify-center items-start w-full">
        ...
        <p>Estamos trabalhando para garantir que o SOS Mecânicos ofereça um grande serviço para vocês</p>
        <p>Em breve teremos mais informações sobre como solicitar serviços de manutenção.</p>
