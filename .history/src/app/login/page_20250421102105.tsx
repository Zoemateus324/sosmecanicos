    ...
    try {
      ...
      if (data?.user) {
        ...
        try {
          ...
          // Verifica qual campo contém o tipo de usuário
          const tipo = userData.tipo || userData.tipo_usuario || userData.role;
        ...
        if (tipo === "cliente") {
          ...
          await router.push("/dashboard/mecanica");
        } else if (tipo === "guincho") {
          await router.push("/dashboard/guincho");
        } else if (tipo === "seguradora") {
          await router.push("/dashboard/seguradora");
        } else {
